...
from routes import auth_routes, story_routes, generate_story_routes
...
app.include_router(generate_story_routes.router)
...
app.mount("/output", StaticFiles(directory="/home/jeonlaejohgun/fastAPI/output"), name="output")
